 ...
 */
pki.createSignatureDigest = function(options) {
 ...
 * @return the certificate.
 */
pki.certificateFromAsn1 = function(obj, computeHash, computeHashSignatureOid) {
  ...
  if(computeHash) {
    ...
    cert.md = pki.createSignatureDigest({
      signatureOid: computeHashSignatureOid || cert.signatureOid,
      type: 'certificate'
    });
...
pki.certificationRequestFromAsn1 = function(obj, computeHash) {
  ...
  if(computeHash) {
    // create digest for OID signature type
    csr.md = pki.createSignatureDigest({
